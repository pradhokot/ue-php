...
<div id="modal-confirm-changepass" class="modal" tabindex="-1">
      ...
      <div class="modal-content border-primary border-3">
         ...
         <div class="modal-body">
            <p class="text-center fs-5">
               Anda akan merubah password sebelumnya
            </p>
            <p class="text-center fs-small m-0">
               Anda tidak akan bisa login menggunakan password yang lama.
            </p>
         </div>
         <div class="modal-footer border-0 flex-nowrap">
            <button type="submit" class="btn w-100 btn-primary">Ganti</button>
